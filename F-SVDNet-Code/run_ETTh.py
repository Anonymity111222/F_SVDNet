...
from experiments.exp_ETTH_FFT import Exp_ETTh

parser = argparse.ArgumentParser(description='FFT on ETT dataset')


parser.add_argument('--model_name', type=str, required=False, default='FFT-test', help='model of the experiment')
### -------  dataset settings --------------
parser.add_argument('--data', type=str, required=False, default='ETTh2', choices=['ETTh1', 'ETTh2', 'ETTm1','WTH','ECL'], help='name of dataset')
...
parser.add_argument('--devices', type=str, default='cuda:3',help='device ids of multile gpus')
                                                                                  
### -------  input/output length settings --------------   
#1200  1440  1680 1920
# seq_len 720    label_len  720     pred_len 720     modes   360     F_channels  7   F_modes  4                                                   
parser.add_argument('--seq_len', type=int, default=1920 , help='input sequence length of SCINet encoder, look back window')
parser.add_argument('--label_len', type=int, default=1920 , help='start token length of Informer decoder')
parser.add_argument('--pred_len', type=int, default=1920 , help='pr   ediction sequence length, horizon')
parser.add_argument('--modes', default=1920  , type=int, help='num of FFT')
...
if args.evaluate:
    ...
    setting = '{}_{}_ft{}_sl{}_ll{}_pl{}_lr{}_bs{}'.format(args.model_name,args.data, args.features, args.seq_len, args.label_len, args.pred_len,args.lr,args.batch_size)
    args.folder_path = 'exp/ett_results/' +args.model_name+ setting + '/'  #save results
    exp = Exp(args)  # set experiments
...
# exp/ETT_checkpoints/FFT-1_ETTh1_ftM_sl96_ll24_pl24_lr0.0001_bs32/ETTh124.bin
# exp/ETT_checkpoints/FFT-1-act_ETTh1_ftM_sl96_ll24_pl24_lr0.0001_bs32/ETTh124.bin